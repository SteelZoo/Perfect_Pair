...
class CreateGameListAdapter: ListAdapter<Question,CreateGameListAdapter.CreateGameListViewHolder>(diffUtil){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CreateGameListViewHolder {
        return CreateGameListViewHolder(ItemQuestionListBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
    ...
    inner class CreateGameListViewHolder(val binding: ItemQuestionListBinding): RecyclerView.ViewHolder(binding.root){
